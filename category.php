...
$allowed_categories = ['raw meat', 'processed meat', 'cooked meat', 'alive rabbit', 'breeding', 'rabbit needs'];
...
<head>
   ...
   <title><?= ucwords($category) ?> - Forest Bounty</title>
   ...
   <style>
      ...
      .raw-meat .product-badge,
      .raw-meat .add-to-cart {
         background: #C44536;
      }
      
      .processed-meat .product-badge,
      .processed-meat .add-to-cart {
         background: #A45C40;
      }
      
      .cooked-meat .product-badge,
      .cooked-meat .add-to-cart {
         background: #855A5C;
      }
      
      .alive-rabbit .product-badge,
      .alive-rabbit .add-to-cart {
         background: #557A46;
      }
      
      .breeding .product-badge,
      .breeding .add-to-cart {
         background: #3B5249;
      }
   </style>
</head>
...
<section class="shop-container <?= str_replace(' ', '-', $category) ?>">
   <!-- Rabbit decorations -->
   ...
   <div class="section-header">
      <h1 class="section-title"><?= ucwords($category) ?></h1>
      <?php
      // Custom subtitle based on category
      $subtitle = '';
      switch($category) {
         case 'raw meat':
            $subtitle = 'Fresh, premium quality rabbit meat for your finest culinary creations';
            $icon = '🥩';
            break;
         case 'processed meat':
            $subtitle = 'Conveniently prepared rabbit meat products ready for cooking';
            $icon = '🍖';
            break;
         case 'cooked meat':
            $subtitle = 'Delicious ready-to-eat gourmet rabbit dishes from our kitchen to yours';
            $icon = '🍽️';
            break;
         case 'alive rabbit':
            $subtitle = 'Healthy, well-cared for live rabbits perfect for your home';
            $icon = '🐰';
            break;
         case 'breeding':
            $subtitle = 'Top quality breeding stock to start or enhance your rabbit breeding program';
            $icon = '🐇';
            break;
         case 'rabbit needs':
            $subtitle = 'Everything you need to care for your rabbits, from food to accessories';
            $icon = '🛒';
            break;
         default:
            $subtitle = 'Hand-selected, ethically sourced products of the highest quality';
            $icon = '🌿';
      }
      ?>
   ...
   <form action="" method="post" class="product-card">
      ...
      <div class="product-media">
         <span class="product-badge"><?= $icon ?> <?= ucwords($category) ?></span>
   ...
   <?php
      ...
      echo '<div class="empty-state">
               <h3 class="empty-message">No ' . $category . ' products available yet!</h3>
               <p>We\'re working on adding more premium selections to this category soon.</p>
            </div>';
   }
   ?>
   </div>
