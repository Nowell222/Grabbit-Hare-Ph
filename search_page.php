...
<section class="search-container">
   ...
   <div class="section-header">
      ...
      <p class="section-subtitle">Find the perfect premium meat for your special occasions</p>
   </div>

   <div class="search-form">
      <form action="" method="post">
         <input type="text" name="search_box" placeholder="Search for premium meats..." maxlength="100" required
                value="<?php echo isset($_POST['search_box']) ? htmlspecialchars($_POST['search_box']) : ''; ?>">
   ...
   <?php
         ...
         echo '<div class="empty-state">
                  ...
                  <p>Try searching with different keywords or browse our premium selection.</p>
               </div>';
      }
   } else {
      echo '<div class="empty-state">
               <h3 class="empty-message">Start your search</h3>
               <p>Enter keywords above to find your perfect premium meats.</p>
            </div>';
   }
   ?>
   </div>
